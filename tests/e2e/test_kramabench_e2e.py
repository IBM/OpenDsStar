...
def test_kramabench_sample_experiment():
    """
    E2E test: Run KramaBench experiment on 3 samples.
    ...
    3. Verifies that the average score is >= 0.0
    4. Validates the structure of outputs and results
    ...
    # Redirect output/cache to tests/e2e/cache_outputs/kramabench/ to avoid polluting benchmark dirs
    from tests.e2e.conftest import redirect_experiment_dirs

    redirect_experiment_dirs(experiment, benchmark_name="kramabench")
