...
def test_databench_sample_experiment():
    """
    E2E test: Run DataBench experiment on 3 samples.

    This test:
    1. Creates a DataBench experiment with 3 questions
    2. Validates default code_mode is stepwise
    3. Runs the complete pipeline (data loading, tool creation, agent execution, evaluation)
