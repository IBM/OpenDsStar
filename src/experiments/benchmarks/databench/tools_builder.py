"""DataBench tools builder implementation.

Builds the standard file tools for DataBench over its parquet corpus.
"""
...
class DataBenchToolsBuilder(ToolBuilder):
    """
    Build retrieval and file-loading tools for the DataBench corpus.
    ...
    def __init__(
        ...
        Args:
            ...
            llm: Model used for file description generation
    ...
    def build_tools(
        ...
        """
        Build DataBench tools from the corpus.
        ...
        logger.info("Building DataBench tools; corpus_available=%s", corpus is not None)
        ...
        logger.info(
            "DataBench tools built: tool_count=%d, tool_names=%s",
            len(tools),
